...
- отделна детайлна страница за всеки инструмент;
- фирмено решение, риск за данните, ценови модел и дата на последен преглед;
- силни страни, ограничения, езици, приложения и вътрешни бележки;
- сравнение на 2 до 4 инструмента в обща таблица;
- откриване на възможни дубликати по име и уеб адрес;
- групова смяна на категория, архивиране и изтриване;
- управляеми категории с преименуване и обединяване;
...
10. `supabase/stage-one-productivity.sql` — разширени профили на инструментите и управляеми категории.
11. `supabase/stage-two-inbox.sql` — оптимизация на входящия поток, metadata и URL проверки за дубликати.
12. `supabase/stage-two-sources.sql` — регистър на източници, включително TikTok, и връзки към съдържанието.
