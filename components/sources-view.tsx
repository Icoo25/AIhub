...
import { ExternalLink, FileText, Globe2, Mail, Music2, Pencil, Plus, Radio, Rss, Search, Trash2, Youtube } from "lucide-react";
...
function sourceIcon(type: ContentSourceType) { return type === "TikTok" ? Music2 : type === "YouTube" ? Youtube : type === "RSS" ? Rss : type === "Бюлетин" ? Mail : type === "Вътрешен" ? FileText : type === "Блог" ? Radio : Globe2; }
